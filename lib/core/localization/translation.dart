...
class MyTranslation extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    "ar": {
      ...
      "login": "تسجيل الدخول",
      "textNavgetorPageSignIn": "ليس لديك حساب ? ",
      "linkNavgetorPageSignIn": "انشاء حساب",
      "labelPhone": "الهاتف",
      ...
      "textNavgetorPageSignUp": " لديك حساب ? ",
      "linkNavgetorPageSignUp": "تسجيل الدخول",
      "signUp": "انشاء حساب",
    ...
    "en": {
      ...
      "login": "Login",
      "textNavgetorPageSignIn": "Dont Have An Account ? ",
      "linkNavgetorPageSignIn": "Sign Up",
      "labelPhone": "Phone",
      ...
      "textNavgetorPageSignUp": " have an account ? ",
      "linkNavgetorPageSignUp": "SignIn",
      "signUp": "Sign Up",
      "27": "Check Email",
